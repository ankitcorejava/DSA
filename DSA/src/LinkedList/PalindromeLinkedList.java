...
/****
 * Steps to Perform Reverse Linked List:**** 1. Create a method to get a Node by
 * an index 2. move from left to right in loop by +1; 3. left = 0 & right =
 * size() -1; 4. swap function to swap values;
 * 
 *****/
public class PalindromeLinkedList {
	...
	private static class LinkedList {
		...
		public ArrayList<Integer> getFromLinkedList(Node head) {
		 ...
		 public boolean isPalindrome(Node head) {
			 ...
			 ArrayList<Integer> list = getFromLinkedList(head);
